  ...
  <div class="container" style="width:100%; text-align: center;">
    ...
    <div class="col-lg-6" style=" display: inline-block; ">
      <div class="jumbotron" style="padding-top: 20px;">
        <form method="post" id="CategoryUpload" name="CategoryUpload" action="CategoryUpload" onsubmit="return check();">
          <h3 style="text-align: center;">문서 목록 등록</h3>
          <p style="text-align: center;">틀린 부분 없이 잘 확인해 등록해주세요</p>
          <div class="input-group mb-3">
            <span class="input-group-text w-90p">이름</span>
            <input type="text" class="form-control" id="categoryName" name="categoryName" placeholder="문서 목록 이름" required >
          </div>
          
          <div class="input-group mb-3">
            <label class="input-group-text w-90p">문서 선택</label>
            <select class="form-select" title="ChangeSelect" id="ChangeSelect" name="ChangeSelect">
              <option value="" disabled selected>선택하시오(미선택 시 최상위 폴더로 지정)</option>
          ...
          <div class="input-group mb-3">
            <span class="input-group-text w-90p">선택한 문서</span>
          ...
          <input type="hidden" class="form-control" id="categoryLv" name="categoryLv" value="0" required readonly>
          <input type="hidden" class="form-control" id="categoryCode" name="categoryCode" value="10000" required readonly>
          
          <input type="submit" class="btn btn-primary form-control" value="문서 목록 등록" onClick="return check()" >
          <div>
