    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse d-lg-flex" id="navbars">
        ...
        <ul class="navbar-nav col-lg-6 justify-content-lg-center">
          ...
          <li class="nav-item">
            <a class="nav-link disabled" aria-current="page" href="Main.jsp">고객사 관리</a>
          </li>
          <li class="nav-item">
            <a class="nav-link disabled" aria-current="page" href="Main.jsp">문서 관리</a>
          </li>
        </ul>
      ...
      <div class="jumbotron">
        <form method="post" action="Login">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" pattern="[A-Za-z0-9]*" placeholder="ID" aria-label="userID" aria-describedby="basic-addon1" name="userID" maxlength="20" required>
          </div>
          
          <div class="input-group mb-3">
            <span class="input-group-text t-c w-90p" id="basic-addon1">비밀번호</span>
            <input type="password" class="form-control"  placeholder="Password" aria-label="userPassword" aria-describedby="basic-addon1"  name="userPassword" maxlength="20" required>
          </div>
